 ...
 */
  ...
  PARAM_DICT_FLAG("ff_me_method","motion-est");
...
//  PARAM_INT("ff_chroma_elim_threshold",chroma_elim_threshold);
  ...
  PARAM_DICT_FLAG("ff_rc_initial_cplx","rc_init_cplx");
...
//  PARAM_INT("ff_scenechange_threshold",scenechange_threshold);
  PARAM_DICT_FLAG("ff_lmin", "lmin");
  PARAM_DICT_FLAG("ff_lmax", "lmax");
...
//  PARAM_INT("ff_quantizer_noise_shaping",quantizer_noise_shaping);
  ...
  PARAM_DICT_FLAG("ff_border_masking","border_mask");
...
//  PARAM_INT("ff_brd_scale",brd_scale);
  ...
  //  PARAM_FLAG("ff_flag_part",AV_CODEC_FLAG_PART); // Unused
  ...
  //  PARAM_FLAG("ff_flag_h263p_umv",AV_CODEC_FLAG_H263P_UMV); // Unused
...
//  PARAM_FLAG2("ff_flag2_strict_gop",AV_CODEC_FLAG2_STRICT_GOP);
  PARAM_DICT_FLAG("ff_coder_type","coder");
